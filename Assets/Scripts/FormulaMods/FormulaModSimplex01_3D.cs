...
public class FormulaModSimplex01_3D : FormulaMod
{
    ...
    public override string GenerateCode(HashSet<int> vars, StringBuilder builder)
    {
        if (false == vars.Contains(VarIndex))
        {
            ...
            var val3 = PickCode(3, m_offsetX, vars, builder);
            var val4 = PickCode(4, m_offsetY, vars, builder);
            var val5 = PickCode(5, m_offsetZ, vars, builder);
            var val6 = PickCode(6, m_mulX, vars, builder);
            var val7 = PickCode(7, m_mulY, vars, builder);
            var val8 = PickCode(8, m_mulZ, vars, builder);
            ...
            builder.AppendLine($"            {val3} + {val0} * {val6},");
            builder.AppendLine($"            {val4} + {val1} * {val7},");
            builder.AppendLine($"            {val5} + {val2} * {val8});");
        }
